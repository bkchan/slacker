...
class calculator_handler(slackbot_handler):
    ...
    def get_commands_and_examples(self):
        return (['If the entire string is a mathematical expression, showme will display the result -- note integer math unless floating point is used specifically.'], ['sm (75.0 - 32) * 5/9'])
